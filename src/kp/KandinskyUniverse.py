...
class KandinskyUniverse:
    def __init__(self, kandinsky_colors, kandinsky_shapes):
        self.kandinsky_colors = kandinsky_colors
        self.kandinsky_shapes = kandinsky_shapes

class SimpleUniverse(KandinskyUniverse):
...
def kandinskyFigureAsImage (shapes, width=600, subsampling = 4):
    '''
    Generate Image of Kandinsky Figure using OpenCV and PIL.
    :param shapes: list of shapes to draw in the figure.
...
# definition of figures using PIL.Draw
